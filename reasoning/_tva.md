---
key: _tva
description: TVA is core semantic logic layer used by ACI
---
[TVA :: Truth + Validation = Alignment]
semantic text-only, tool-agnostic, loads pre-response, works across latent space, per-node contextual output, compare and modulates via metacognition.
[Similarity / Tension]
